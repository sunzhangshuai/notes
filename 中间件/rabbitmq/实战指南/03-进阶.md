...
[代码](exercises/src/main/java/com/ae)
...
[代码](exercises/src/main/java/com/dxq)
...
3. 发到死信交换器的routing-key沿用正常队列的，也可手动指定。
   ...
   ```java
   args.put("x-dead-letter-routing-key", dxRoutingKey);
   ```
...
[代码](exercises/src/main/java/com/delay)
...
[代码](exercises/src/main/java/com/priority)
...
[代码](exercises/src/main/java/com/rpc)
...
[代码](exercises/src/main/java/com/confirm)
